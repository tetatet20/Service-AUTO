...
sendButton.addEventListener('click', function () {
    ...
    else {fetch(`https://api.telegram.org/bot5347573628:AAGlHUQzNDeAaC5WSToxc5cXpFYProrrqoU/sendMessage?chat_id=-1001776896462&text=${date}%0AИмя%20%2D%20${nameValue}%0AНомер%20%2D%20${numberValue}%0AEmail%20%2D%20${emailValue}`)
